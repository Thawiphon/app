...
{
    /// <summary>
    /// Phone application page for starters_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class starters_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for starters_Detail and all its components.
        /// </summary>
        public starters_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramastarters_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramastarters_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramastarters_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramastarters_Detail(Panoramastarters_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramastarters_Detail(PanoramaItem panoramaItem)        
        {
