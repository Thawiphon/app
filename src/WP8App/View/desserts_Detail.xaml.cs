...
{
    /// <summary>
    /// Phone application page for desserts_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class desserts_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for desserts_Detail and all its components.
        /// </summary>
        public desserts_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramadesserts_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramadesserts_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramadesserts_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramadesserts_Detail(Panoramadesserts_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramadesserts_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.Idesserts_dessertsCollection>();
				AddHomeAppBarButton();
				...
				((IViewModels.Idesserts_DetailViewModel)DataContext).CurrentdessertsSchema = pinnedItem;				
			}
		}
