...
{
    /// <summary>
    /// Phone application page for beverages_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class beverages_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for beverages_Detail and all its components.
        /// </summary>
        public beverages_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramabeverages_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramabeverages_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramabeverages_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramabeverages_Detail(Panoramabeverages_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramabeverages_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.Ibeverages_beveragesCollection>();
				AddHomeAppBarButton();
				...
				((IViewModels.Ibeverages_DetailViewModel)DataContext).CurrentbeveragesSchema = pinnedItem;				
			}
		}
        ...
        private void AddHomeAppBarButton()
        {
			...
			{ 
				new Ioc.Container().Resolve<IServices.INavigationService>().NavigateTo<IViewModels.Inavigate_MenuViewModel>(); 
