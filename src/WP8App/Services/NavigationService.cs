...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.Inavigate_MenuViewModel), "/View/navigate_Menu.xaml" },
            { typeof(IViewModels.Istarters_ListViewModel), "/View/starters_List.xaml" },
            { typeof(IViewModels.Istarters_DetailViewModel), "/View/starters_Detail.xaml" },
            { typeof(IViewModels.Idesserts_ListViewModel), "/View/desserts_List.xaml" },
            { typeof(IViewModels.Idesserts_DetailViewModel), "/View/desserts_Detail.xaml" },
            { typeof(IViewModels.Ibeverages_ListViewModel), "/View/beverages_List.xaml" },
            { typeof(IViewModels.Ibeverages_DetailViewModel), "/View/beverages_Detail.xaml" },
