...
{
    /// <summary>
    /// Implementation of the startersSchema Data Schema.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class startersSchema : BindableBase
    {
	    /// <summary>
        /// Identifier for instances created according startersSchema Data Schema.
        /// </summary>
        ...
        {
            var cmp = obj as startersSchema;
			
			if(cmp == null) return false;
			
			return Equals(Subtitle, cmp.Subtitle) && Equals(Title, cmp.Title) && Equals(Image, cmp.Image) && Equals(Description, cmp.Description);
        }
