...
{
    /// <summary>
    /// Fake beveragesSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class Fakebeverages_beveragesCollection : Ibeverages_beveragesCollection 
    {
        ...
        public ObservableCollection<Entities.beveragesSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.beveragesSchema> 
			{ 
			...
			return new ObservableCollection<Entities.beveragesSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.beveragesSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of beveragesSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.beveragesSchema>.FilterCollection(filter, GetData());
        }
