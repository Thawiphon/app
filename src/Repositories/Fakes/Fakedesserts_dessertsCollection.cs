...
{
    /// <summary>
    /// Fake dessertsSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class Fakedesserts_dessertsCollection : Idesserts_dessertsCollection 
    {
        ...
        public ObservableCollection<Entities.dessertsSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.dessertsSchema> 
			{ 
			...
			return new ObservableCollection<Entities.dessertsSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.dessertsSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of dessertsSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.dessertsSchema>.FilterCollection(filter, GetData());
        }
